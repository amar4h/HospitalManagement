...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['name']) || empty($data['phone']) || empty($data['gender'])) {
        ...
        logActivity('patient_update', 'Updated patient: ' . $data['name'] . ' (' . $patient['patient_id'] . ')');
...
<div class="page-header">
    ...
    <div>
        <a href="index.php?page=patient-view&id=<?= $id ?>" class="btn btn-outline-secondary">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="badge bg-secondary ms-2"><?= $patient['patient_id'] ?></span>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" name="dob" id="dob" class="form-control" value="<?= $patient['dob'] ?>" max="<?= date('Y-m-d') ?>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Age</label>
                            <input type="text" id="age" class="form-control" value="<?= calculateAge($patient['dob']) ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="marital_status" class="form-select">
                                ...
                                <option value="<?= $status ?>" <?= ($patient['marital_status'] ?? '') === $status ? 'selected' : '' ?>><?= $status ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="zip_code" class="form-control" value="<?= htmlspecialchars($patient['zip_code'] ?? '') ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="emergency_contact_relation" class="form-control" value="<?= htmlspecialchars($patient['emergency_contact_relation'] ?? '') ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="chronic_conditions" class="form-control" rows="2"><?= htmlspecialchars($patient['chronic_conditions'] ?? '') ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Current Medications</label>
                        <textarea name="current_medications" class="form-control" rows="2"><?= htmlspecialchars($patient['current_medications'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="insurance_id" class="form-control" value="<?= htmlspecialchars($patient['insurance_id'] ?? '') ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <textarea name="notes" class="form-control" rows="4"><?= htmlspecialchars($patient['notes'] ?? '') ?></textarea>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="index.php?page=patient-view&id=<?= $id ?>" class="btn btn-outline-secondary w-100">
            ...
            <div class="card">
                <div class="card-body small text-muted">
                    ...
                    <p class="mb-1"><strong>Registered:</strong> <?= formatDateTime($patient['created_at']) ?></p>
                    <?php if (!empty($patient['updated_at'])): ?>
                    <p class="mb-0"><strong>Last Updated:</strong> <?= formatDateTime($patient['updated_at']) ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
